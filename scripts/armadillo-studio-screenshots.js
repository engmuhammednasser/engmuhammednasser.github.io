(function () {
  ...
  function initArmadilloStudioScreenshots() {
  ...
  if (document.readyState === "loading") {
    document.addEventListener("DOMContentLoaded", initArmadilloStudioScreenshots, {
      once: true,
    });
  } else {
    initArmadilloStudioScreenshots();
  }
})();
